...
const Title: FC = ({ children }) => {
  return (
    <Text variant="title" color="text.500" textAlign="justify">
      {children}
    </Text>
  );
};
...
const Description: FC = ({ children }) => {
  return (
    <Text variant="field" color="text.500" textAlign="justify">
      {children}
    </Text>
  );
};
...
const TermsOfServices = () => {
  ...
  return (
    <Grid textAlign="center" gridGap={10}>
      ...
      <Heading text="termsofservices.heading" mt="4.8rem" />
      <Grid gridGap={20} px={{ xs: '1rem', md: '5rem' }} py={{ xs: '2rem', md: '5rem' }}>
        <Box>
          <Title>AGREEMENT TO USE</Title>
          <Description>
            These Terms of Use constitute a legally binding agreement made between you, whether
            personally or on behalf of an entity (“you”) and Farm Grub, Inc (“Company”, “we”, “us”,
            or “our”), concerning your access to and use of the farmgrub.com website as well as any
            other media form, media channel, mobile website or mobile application related, linked,
            or otherwise connected thereto (collectively, the “Site”). You agree that by accessing
        ...
        <Box>
          ...
          <Description>We accept the following forms of payment:</Description>
        ...
        <Box>
          ...
          <Description>6. Engage in unauthorized framing of or linking to the Site.</Description>
          <Description>
          ...
          <Description>12. Sell or otherwise transfer your profile.</Description>
          <Description>
        ...
        <Box>
          ...
          <Description>4. Your Contributions are not false, inaccurate, or misleading.</Description>
          <Description>
          ...
          <Description>
            ...
            these Terms of Use and may result in, among other things, termination or suspension of
        ...
        <Box>
          ...
          <Description>
            ...
            us and/or grant us access to your Third-Party Account, without breach by you of any of
        ...
        <Box>
          ...
          <Description>
            We care about data privacy and security. By using the Site or the Marketplace Offerings,
            you agree to be bound by our Privacy Policy posted on the Site, which is incorporated
            into these Terms of Use. Please be advised the Site and the Marketplace Offerings are
            hosted in the United States. If you access the Site or the Marketplace Offerings from
            ...
            United States, and you expressly consent to have your data transferred to and processed
        ...
        <Box>
          ...
          <Description>
            ...
            OFFERINGS OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY
        ...
        <Box>
          ...
          <Description>
            ...
            and support the Site or the Marketplace Offerings or to supply any corrections, updates,
        ...
        <Box>
          ...
          <Description>
            ...
            by and construed in accordance with the laws of the State of Tennessee applicable to
            agreements made and to be entirely performed within the State of Tennessee, without
            regard to its conflict of law principles.
          </Description>
        </Box>
        <Box>
          <Title>DISPUTE RESOLUTION</Title>
          <Description>Informal Negotiations</Description>
          <Description>
            To expedite resolution and control the cost of any dispute, controversy, or claim
            related to these Terms of Use (each a Dispute and collectively, the “Disputes”) brought
          ...
          <Description>Binding Arbitration</Description>
          <Description>
            ...
            arbitrator fails to do so. Except where otherwise required by the applicable AAA rules
            or applicable law, the arbitration will take place in Knox, Tennessee. Except as
          ...
          <Description>
            ...
            shall be commenced or prosecuted in the state and federal courts located in knox,
          ...
          <Description>
            ...
            Parties individually. The the full extent permitted by law, (a) no arbitration shall be
          ...
          <Description>Exceptions to Informal Negotiations and Arbitration</Description>
          <Description>
        ...
        <Box>
          ...
          <Description>
            ...
            OF ANY WEBSITES LINKED TO THIS SITE AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY
            ...
            USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY
        ...
        <Box>
          ...
          <Description>
            ...
            TIMES BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX
            (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR $500.00 USD. CERTAIN US STATE
        ...
        <Box>
          ...
          <Description>
            ...
            of the Site; (2) breach of these Terms of Use; (3) any breach of your representations
            and warranties set forth in these Terms of Use; (4) your violation of the rights of a
        ...
        <Box textAlign="left">
          ...
          <Text variant="field" color="text.500" lineHeight="1.2rem" mt={15}>
            4214 Beechwood Rd
          </Text>
          <Text variant="field" color="text.500" lineHeight="1.2rem">
            Knoxville, TN 37920
          </Text>
          <Text variant="field" color="text.500" lineHeight="1.2rem">
            United States
