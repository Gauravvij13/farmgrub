...
export type ConfirmedOrderDetailProps = {};
...
export const ConfirmedOrderDetail: FC<ConfirmedOrderDetailProps> = () => {
  ...
  const onBackButton = useCallback(() => push('/shop/main'), [push]);
        ...
        <>
          <Box pt="1.6rem">
            <Grid pb={15} px="1.6rem">
              <BackButton top={0} onClick={onBackButton} />
              <Text
                variant="body"
                id="order.detail.back.to.store"
                color="steelgrey.500"
                left={27}
                top={-6}
                mb={0}
